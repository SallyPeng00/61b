...
public class RuntimeQuiz {
    ...
    public static Runtime f2_o_runtime = Runtime.EXPONENTIAL;
    public static Runtime f2_theta_runtime = Runtime.EXPONENTIAL;
    public int f2(int n) {
        if (n <= 1) return n;
        f1(new int[n]);
    ...
    public static Runtime f4_omega_runtime = Runtime.EXPONENTIAL;
    public static Runtime f4_o_runtime = Runtime.EXPONENTIAL;
    public static Runtime f4_theta_runtime = Runtime.EXPONENTIAL;
    ...
    public static Runtime f5_omega_runtime = Runtime.LINEARITHMIC;
    ...
    public static Runtime f6_theta_runtime = Runtime.CONSTANT;
