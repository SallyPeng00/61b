...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double real_presentValue = presentValue * Math.pow((1-inflationRate/100), numYears(targetYear));
        return futureValue(real_presentValue, rate, targetYear);
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        ...
        for (int yearTill = targetYear - THIS_YEAR; yearTill > 0; yearTill--) {
            savings += futureValue(perYear, rate, THIS_YEAR+yearTill);
        }
        return savings;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        double realSavings = totalSavings(perYear, targetYear, rate) * Math.pow((1-inflationRate/100), numYears(targetYear));
        return realSavings;
